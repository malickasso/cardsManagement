    ...
    <div class="bg-gray-50 min-h-screen p-6 md:p-8" x-data="typeCarteManager()">
        <div class="mb-8 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <p class="mt-1 text-gray-600">Alimentation depuis la table <span class="font-semibold">type_carte</span>.</p>
            </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-600">Nom</th>
                    ...
                    <tbody class="divide-y divide-gray-100 bg-white">
                        @forelse ($typesCartes as $type)
                            <tr class="hover:bg-gray-50">
                                <td class="px-4 py-3 text-sm text-gray-800">{{ $type->id_type_carte }}</td>
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <form action="{{ route('admin.type-cartes.destroy', $type->id_type_carte) }}" method="POST"
                                            onsubmit="return confirm('Supprimer ce type de carte ?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
        ...
        <div x-show="showCreate" x-transition class="fixed inset-0 z-50 overflow-y-auto" style="display:none;">
            <div class="flex items-center justify-center min-h-screen px-4 py-8">
                ...
                <form action="{{ route('admin.type-cartes.store') }}" method="POST" class="p-6 space-y-4">
                    @csrf
                    <div>
                        <label class="mb-1 block text-sm font-semibold text-gray-700">Nom <span class="text-red-500">*</span></label>
                        <input type="text" name="nom_type_carte" required maxlength="100" value="{{ old('nom_type_carte') }}"
        ...
        <div x-show="showEdit" x-transition class="fixed inset-0 z-50 overflow-y-auto" style="display:none;">
            <div class="flex items-center justify-center min-h-screen px-4 py-8">
                ...
                <div @click.away="showEdit = false" class="relative w-full max-w-xl overflow-hidden rounded-xl bg-white shadow-xl">
                    <div class="bg-blue-800 px-6 py-4">
                        <div class="flex items-center justify-between">
        ...
        <div x-show="showView" x-transition class="fixed inset-0 z-50 overflow-y-auto" style="display:none;">
            <div class="flex items-center justify-center min-h-screen px-4 py-8">
                ...
                <div @click.away="showView = false" class="relative w-full max-w-xl overflow-hidden rounded-xl bg-white shadow-xl">
                    <div class="bg-blue-800 px-6 py-4">
                        <div class="flex items-center justify-between">
